...
if __name__ == '__main__':
    Task1plot('./pkl/mutliclass-model_train_loss_0.01.pkl', './pkl/mutliclass-model_val_loss_0.01.pkl', 'Task1_Loss.png')
    Task2plot('./pkl/multilabel-model_train_loss_0.1.pkl', './pkl/multilabel-model_val_loss_0.1.pkl', 'Task2_Loss.png')
