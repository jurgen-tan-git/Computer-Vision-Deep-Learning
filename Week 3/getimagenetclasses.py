...
def testparse():
  nm='./ILSVRC2012_bbox_val_v3/val/ILSVRC2012_val_00000001.xml'
...
def test_parseclasslabel():
  ...
  print(synsetstoclassdescr[indicestosynsets[label]] )


def get_classlabel(filename:str):
  filen='./synset_words.txt'
  nm='./ILSVRC2012_bbox_val_v3/val/'
  
  file = nm + filename + '.xml'
  
  indicestosynsets,synsetstoindices,synsetstoclassdescr=parsesynsetwords(filen)
  
  label,firstname=parseclasslabel(file,synsetstoindices)
  
  return synsetstoclassdescr[indicestosynsets[label]]

def main():
  print(get_classlabel('ILSVRC2012_val_00000002'))
